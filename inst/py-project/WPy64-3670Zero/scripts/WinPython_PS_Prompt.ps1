...
if (-not ($env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\python-3.6.7.amd64")) ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\python-3.6.7.amd64"


$env:WINPYVER = '3.6.7.0Zero'
